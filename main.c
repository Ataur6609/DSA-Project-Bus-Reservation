...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Shohag Express","GoldenLine Express","Dhaka Express","Rajdhani Express","Satkhira Express","Truro Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
    ...
    do
{
	...
	i=0;
	//scanf("%s",&pword);
		if(strcmp(uname,"shahidul")==0 && strcmp(pword,"ashis")==0)
	{
